...
//@AllArgsConstructor
//@Service
public class NodeInstanceAttributeHistoryService
{
...
//            if(attributeEntity.getEndDate().getTime() < ConstantsUtility.NO_END_DATE_VALUE ) {
...
//      params.put("endDate", ConstantsUtility.NO_END_DATE_VALUE);
...
//          .endDate(attributeDto.getEndDate() != null ? attributeDto.getEndDate() : ConstantsUtility.NO_END_DATE)
//          .build();
//    }
