...
import services.AttributeHistoryEntryPoint;
...
// update
   ...
   public ResponseEntity<AttributeHistoryResponse> getNodeInstanceWithAttributeHistory(
      ...
      @RequestParam (required = false, defaultValue = UnitElasticConstants.DEFAULT_LIMIT) String limit,
      @RequestParam (required = false, defaultValue = UnitElasticConstants.DEFAULT_OFFSET) String offset)
   {
      if(fromTime == null || fromTime.isEmpty()) {
         fromTime = String.valueOf(0);
      }
      if(toTime == null || toTime.isEmpty()) {
         toTime = String.valueOf(UnitElasticConstants.NO_END_DATE_VALUE);
      }
   ...
   public void purgeByTimenodeinstancesattributeHistory(@RequestParam(required = true) String batchCount, @RequestParam(required = false) String endTime) throws Exception
   {
      if(endTime == null || endTime.isEmpty()) {
         endTime = String.valueOf(UnitElasticConstants.NO_END_DATE_VALUE);
      }
...
//      @ApiParam(value = "limit", required = false) @RequestParam(required = false, defaultValue = UnitElasticConstants.DEFAULT_LIMIT) String limit,
//      @ApiParam(value = "offset", required = false) @RequestParam(required = false, defaultValue = UnitElasticConstants.DEFAULT_OFFSET) String offset)
//   {
